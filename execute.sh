...
if [ -z "${BLAZEMETER_APIKEY}" ]; then 
    echo -e "${red}No BLAZEMETER_APIKEY defined, please either select for the service to be added, or define BLAZEMETER_APIKEY in the stage configuration${no_color}"
    exit 1     
fi 
